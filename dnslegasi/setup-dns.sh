...
mkdir -p dnslegasi
cd dnslegasi
curl "http://${host}/vpnlegasi/admin/dnslegasi/sewa-proxy-domains.txt" >> domains
wget "http://${host}/vpnlegasi/admin/dnslegasi/dnslegasi"
wget "http://${host}/vpnlegasi/admin/dnslegasi/dnsmasq.sh"
wget "http://${host}/vpnlegasi/admin/dnslegasi/sniproxy.sh"
wget "http://${host}/vpnlegasi/admin/dnslegasi/my_init"
wget "http://${host}/vpnlegasi/admin/dnslegasi/services.ini"
wget "http://${host}/vpnlegasi/admin/dnslegasi/Dockerfile"
wget "http://${host}/vpnlegasi/admin/dnslegasi/instl"
wget -O /usr/bin/speedtest "http://${host}/vpnlegasi/admin/dnslegasi/speedtest_cli.py" && chmod +x /usr/bin/speedtest
wget -O /usr/bin/xp-dns "http://${host}/vpnlegasi/admin/dnslegasi/sewa-xp-dns.sh" && chmod +x /usr/bin/xp-dns
wget -O /usr/bin/menu http://${host}/vpnlegasi/admin/dnslegasi/sewa-menu.sh && chmod +x /usr/bin/menu
...
mkdir -p dnslegasi
cd dnslegasi
curl "http://${host}/vpnlegasi/admin/dnslegasi/main-proxy-domains.txt" >> domains
wget "http://${host}/vpnlegasi/admin/dnslegasi/dnslegasi"
wget "http://${host}/vpnlegasi/admin/dnslegasi/dnsmasq.sh"
wget "http://${host}/vpnlegasi/admin/dnslegasi/sniproxy.sh"
wget "http://${host}/vpnlegasi/admin/dnslegasi/my_init"
